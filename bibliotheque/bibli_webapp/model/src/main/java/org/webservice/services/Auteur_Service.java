 ...
 * 
 */
@WebServiceClient(name = "Auteur", targetNamespace = "http://services.webservice.org/", wsdlLocation = "http://localhost:8080/webservice/Auteur?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/webservice/Auteur?wsdl");
